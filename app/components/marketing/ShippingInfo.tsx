    ...
    <section id="envios" className="scroll-mt-24">
      <div className="bt-container bt-section">
        <div className="flex flex-col items-start gap-4">
          <SectionLabel index="05">Envíos a todo el Ecuador</SectionLabel>
          <h2 className="bt-h2 text-ink">Información de envío</h2>
        </div>
        {/* The promotion is the one contained surface of the section. */}
        <div className="mt-8 rounded-card bg-cream px-6 py-5 text-purple-dark">
